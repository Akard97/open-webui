...
USER_PERMISSIONS_FEATURES_POLICY_CHECKER = (
    os.environ.get('USER_PERMISSIONS_FEATURES_POLICY_CHECKER', 'False').lower() == 'true'
)

USER_PERMISSIONS_FEATURES_POLICY_APPROVER = (
    os.environ.get('USER_PERMISSIONS_FEATURES_POLICY_APPROVER', 'False').lower() == 'true'
)
