<script lang="ts">
	...
	// Hide the Private/Public header when the host UI manages visibility
	// itself (e.g. SiteEditor's level radios) and only the grant list is wanted.
	export let showVisibilitySelect = true;
